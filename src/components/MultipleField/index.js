...
cm.getConstructor('Com.MultipleField', function(classConstructor, className, classProto, classInherit){
    ...
    classProto.renderView = function(){
        ...
        that.nodes['container'] = cm.node('div', {'class' : 'com__multiple-field'});
        that.nodes['content'] = cm.node('div', {'class' : 'com__multiple-field__content'});
        // List
    ...
    classProto.renderItem = function(item, params){
        ...
        if(that.params['max'] === 0 || that.items.length < that.params['max']){
            ...
            // Structure
            item['container'] = cm.node('div', {'class' : 'com__multiple-field__item', 'data-node' : 'items:[]:container'},
