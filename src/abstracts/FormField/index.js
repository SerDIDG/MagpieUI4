...
cm.getConstructor('Com.AbstractFormField', function(classConstructor, className, classProto, classInherit){
    ...
    classProto.onValidateParams = function(){
        ...
        that.params['constructorParams']['request'] = that.params['request'];
        // Components
        ...
        // Request
        if(that.params['preload'] && !cm.isEmpty(that.params['request']) && !cm.isEmpty(that.params['request']['url'])){
            that.isRequest = true;
        }
    };
    ...
    classProto.renderViewModel = function(){
        ...
        if(!that.isRequest || that.isPreloaded){
